			...
			<Html lang="en" className="bg-gray-100">
				...
				<Container className="bg-white px-4 pb-4 rounded">
					...
					<Section className="text-center">
						<Img
							className="w-48 py-4 mx-auto "
							src="https://res.cloudinary.com/dqjnvq4gv/image/upload/v1724453947/success-reset-passsword_tcsyr4.png"
						/>
						...
						<Section className="px-6">
							<Button
								...
								className="bg-cyan-700 w-full mx-auto rounded-md py-4 text-center text-sm leading-none text-white my-4"
							>
								Continue Login
							</Button>
						</Section>
